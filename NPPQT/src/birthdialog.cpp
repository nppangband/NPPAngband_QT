    ...
    ui(new Ui::BirthDialog)
{
    ...
    int h = ui->stats_table->rowHeight(0);

    ui->stats_table->setMinimumSize(w * 20, h * 10);

    ui->edit_table->setMinimumSize(w * 50, h * 10);

    ui->abilities_table->setMinimumSize(w * 20, h * 12);
