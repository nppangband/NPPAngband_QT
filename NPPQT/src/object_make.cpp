...
void steal_object_from_monster(int y, int x)
{
    ...
    else
    {
        ...
        if (!sq_flag)
        {
            ...
            {
                message(QString("You have no room in your backpack for %1.") .arg(o_name));

                message(QString("%1 falls to the dungeon floor.") .arg(o_name));
            ...
            else
            {
                ...
                /* Message */
                message(QString("You have burgled %1 (%2).") .arg(o_name) .arg(index_to_label(item_new)));
            }
        }
        ...
        else if (i_ptr->is_artifact())
        {
            ...
            if (!inven_carry_okay(i_ptr))
            {
                ...
                message(QString("%1 falls the dungeon floor.") .arg(o_name));
        ...
        else
        {
            ...
            message(QString("You have burgled %1.{squelched}") .arg(o_name));
